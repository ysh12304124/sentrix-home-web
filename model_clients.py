...
from .face_embeddings import AdaFaceAdapter, FaceEmbeddingUnavailable, MagFaceAdapter
                ...
                if self.identity_model in {"adaface", "magface"}:
                    ...
                    if not self.identity_configured:
                        ...
                        try:
                            ...
                            result["quality"] = min(1.0, max(result["quality"], embedded.quality_signal / 10.0))
