...
if ! curl -s -m 2 http://127.0.0.1:8101/health >/dev/null 2>&1; then
  ...
  cd /home/realmagic/Github/Sentrix-Home-Web
...
import onnxruntime
required = [
    Path(os.getenv("RETINAFACE_MODEL_PATH", "/home/realmagic/benchmarks/retinaface/retinaface_r50.onnx")),
...
BIG_MODEL_ENV_FILE="${SENTRIX_BIG_MODEL_ENV_FILE:-/home/realmagic/.config/sentrix/big_model.env}"
...
exec env CUDA_VISIBLE_DEVICES=0 SENTRIX_VLLM_API_URL=http://127.0.0.1:8500 SENTRIX_VLLM_MANAGER_API=http://127.0.0.1:8500 SENTRIX_VLLM_REGISTRY=/home/realmagic/Github/Sentrix-Home-Web/configs/sentrix_vllm_registry_local_100.json SENTRIX_VLLM_BASE_URL=http://127.0.0.1:8100/v1 SENTRIX_ASSISTANT_TURN_WORKERS=4 SENTRIX_PIPELINE_MAX_WORKERS=12 SENTRIX_PIPELINE_MAX_RETRIES=1 SENTRIX_EVENT_SUMMARY_MAX_WORKERS=16 SENTRIX_FACE_GPU_SESSION_LIMIT_MIB=1024 SENTRIX_RETINAFACE_GPU_SESSION_LIMIT_MIB=768 SENTRIX_FACE_GPU_MAX_CONCURRENCY=4 SENTRIX_API_PORT=8091 SENTRIX_THIN_AGENT_V1=1 SENTRIX_EVIDENCE_MULTI_RETRIEVER_V1=1 SENTRIX_IMAGE_EMBEDDER=chinese_clip SENTRIX_TEXT_EMBEDDER=bge SENTRIX_MODEL_SPLIT_V1=1 SENTRIX_AGENT_MODEL_PROFILE=quality_12b SENTRIX_AGENT_STAGE_TRACE=1 SENTRIX_CONVERSATION_STORE_V1=1 SENTRIX_EVIDENCE_ANSWER_12B=1 CLIP_DEVICE=cpu \
  ...
  ADAFACE_MODEL_PATH=/home/realmagic/models/AdaFace/pretrained/adaface_ir50_ms1mv2.ckpt ADAFACE_REPO_ROOT=/home/realmagic/models/AdaFace \
