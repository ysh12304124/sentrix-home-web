...
class MemoryStoreTests(unittest.TestCase):
    ...
    def test_same_time_same_location_different_activities_do_not_merge(self):
        first_asset = self.store.create_asset("same_time_a", "a.jpg", "image", "/tmp/a.jpg", metadata={
            "captured_at": "2026-07-01T10:00:00+08:00", "captured_location": "城市公园", "source_album_id": "album-a",
        })
        second_asset = self.store.create_asset("same_time_b", "b.jpg", "image", "/tmp/b.jpg", metadata={
            "captured_at": "2026-07-01T10:00:00+08:00", "captured_location": "城市公园", "source_album_id": "album-b",
        })
        first = self.store.add_observation(first_asset["id"], {
            "captured_at": "2026-07-01T10:00:00+08:00", "place": "城市公园", "activity": "生日庆祝", "event_type": "庆祝", "objects": ["蛋糕"],
        })
        second = self.store.add_observation(second_asset["id"], {
            "captured_at": "2026-07-01T10:00:00+08:00", "place": "城市公园", "activity": "家庭维修", "event_type": "维修", "objects": ["工具箱"],
        })
